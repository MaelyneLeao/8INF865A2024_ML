...
fun TipTimeLayout() {
    ...
    Column(
        ...
        editNumberField(R.string.bill_amount,
            ...
            onValueChange = { amountInput = it },modifier = Modifier.padding(bottom = 32.dp).fillMaxWidth())
...
@Composable
fun editNumberField(@StringRes label: Int, @DrawableRes leadingIcon: Int, keyboardOptions: KeyboardOptions, value: String,
